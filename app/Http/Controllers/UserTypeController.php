...
class UserTypeController extends Controller
{
    ...
    public function update(Request $request, $userTypeId)
    {
        ...
        $userType->save();
        return redirect()->route('permissions.index')->with('success','Permissions has been updated successfully');
    }
                ...
                return '
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1" style="">
                                    <a class="dropdown-item" href="'.route('permissions.edit', $vehicle->id).'">'.trans('general.edit').'</a>
                                </div>
                            </div>
                        ';
            })
